...
\mbox{\hyperlink{_multi_body_tree_impl_8hpp}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00007\ }
\DoxyCodeLine{00008\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{_i_d_config_8hpp}{../IDConfig.hpp}}"{}}}
\DoxyCodeLine{00009\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{_multi_body_tree_8hpp}{../MultiBodyTree.hpp}}"{}}}
\DoxyCodeLine{00010\ }
\DoxyCodeLine{00011\ \textcolor{keyword}{namespace\ }\mbox{\hyperlink{namespacebt_inverse_dynamics}{btInverseDynamics}}}
\DoxyCodeLine{00012\ \{}
\DoxyCodeLine{00016\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structbt_inverse_dynamics_1_1_rigid_body}{RigidBody}}}
\DoxyCodeLine{00017\ \{}
\DoxyCodeLine{00018\ \ \ \ \ \mbox{\hyperlink{structbt_inverse_dynamics_1_1_rigid_body_abc6bd9404bac2377c068148d7f9feb3c}{ID\_DECLARE\_ALIGNED\_ALLOCATOR}}();}
\DoxyCodeLine{00019\ \ \ \ \ \textcolor{comment}{//\ 1\ Inertial\ properties}}
\DoxyCodeLine{00021\ \ \ \ \ \mbox{\hyperlink{_i_d_config_8hpp_a62da9e31a0ad9268fd88e95068855613}{idScalar}}\ \mbox{\hyperlink{structbt_inverse_dynamics_1_1_rigid_body_a9c2c26d13a5bfceeb1c936830ef98d75}{m\_mass}};}
...
\DoxyCodeLine{00084\ \ \ \ \ \mbox{\hyperlink{namespacebt_inverse_dynamics_a1336af885c4be24650152dabcfa421e7}{JointType}}\ \mbox{\hyperlink{structbt_inverse_dynamics_1_1_rigid_body_abf03ba35f65fcf499e232812fc6d50ff}{m\_joint\_type}};}
...
\DoxyCodeLine{00109\ \ \ \ \ \mbox{\hyperlink{_i_d_config_8hpp_a62da9e31a0ad9268fd88e95068855613}{idScalar}}\ \mbox{\hyperlink{structbt_inverse_dynamics_1_1_rigid_body_a373da26934541537bcd9037f47502b5d}{m\_subtree\_mass}};}
...
\DoxyCodeLine{00131\ \{}
\DoxyCodeLine{00132\ \ \ \ \ \textcolor{keyword}{friend}\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classbt_inverse_dynamics_1_1_multi_body_tree_1_1_multi_body_impl_aeb0bfb6b1a3aa8e1ac6a14cbc60e1b03}{MultiBodyTree}};}
\DoxyCodeLine{00133\ }
\DoxyCodeLine{00134\ \textcolor{keyword}{public}:}
\DoxyCodeLine{00135\ \ \ \ \ \mbox{\hyperlink{classbt_inverse_dynamics_1_1_multi_body_tree_1_1_multi_body_impl_a2475beb8484c7a38a7386aad1436704e}{ID\_DECLARE\_ALIGNED\_ALLOCATOR}}();}
\DoxyCodeLine{00136\ }
\DoxyCodeLine{00137\ \ \ \ \ \textcolor{keyword}{enum}\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1_multi_body_tree_1_1_multi_body_impl_a7c7d3233955377c26cfc68326684e4ae}{KinUpdateType}}}
\DoxyCodeLine{00138\ \ \ \ \ \{}
\DoxyCodeLine{00139\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classbt_inverse_dynamics_1_1_multi_body_tree_1_1_multi_body_impl_a7c7d3233955377c26cfc68326684e4aeaa6f2d5a8fd62a957d368d7eedf4a2d75}{POSITION\_ONLY}},}
\DoxyCodeLine{00140\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classbt_inverse_dynamics_1_1_multi_body_tree_1_1_multi_body_impl_a7c7d3233955377c26cfc68326684e4aeace8e3a4d698093901125a8fc47d0aae5}{POSITION\_VELOCITY}},}
\DoxyCodeLine{00141\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classbt_inverse_dynamics_1_1_multi_body_tree_1_1_multi_body_impl_a7c7d3233955377c26cfc68326684e4aea0a22ab843585d523aba249b793062846}{POSITION\_VELOCITY\_ACCELERATION}}}
\DoxyCodeLine{00142\ \ \ \ \ \};}
\DoxyCodeLine{00143\ }
...
\DoxyCodeLine{00159\ \ \ \ \ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1_multi_body_tree_afa6df6ee25f28a4de404d82c6bbf78ff}{calculateKinematics}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1vecx}{vecx}}\&\ q,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1vecx}{vecx}}\&\ u,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1vecx}{vecx}}\&\ dot\_u,\ \textcolor{keyword}{const}\ KinUpdateType\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a890efa53b3d7deeeced6f3a0d6653ed3}{type}});}
\DoxyCodeLine{00160\ \textcolor{preprocessor}{\#if\ (defined\ BT\_ID\_HAVE\_MAT3X)\ \&\&\ (defined\ BT\_ID\_WITH\_JACOBIANS)}}
\DoxyCodeLine{00162\ \ \ \ \ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1_multi_body_tree_ab28d924ffc2226b224e2046497162227}{calculateJacobians}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1vecx}{vecx}}\&\ q,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1vecx}{vecx}}\&\ u,\ \textcolor{keyword}{const}\ KinUpdateType\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a890efa53b3d7deeeced6f3a0d6653ed3}{type}});}
\DoxyCodeLine{00164\ \ \ \ \ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1_multi_body_tree_a968d4cf54e4d9ed909dfde46ca82d074}{getBodyDotJacobianTransU}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ body\_index,\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1vec3}{vec3}}*\ world\_dot\_jac\_trans\_u)\ \textcolor{keyword}{const};}
\DoxyCodeLine{00166\ \ \ \ \ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1_multi_body_tree_aa62a773bee2530c019967e4a785d6b62}{getBodyDotJacobianRotU}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ body\_index,\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1vec3}{vec3}}*\ world\_dot\_jac\_rot\_u)\ \textcolor{keyword}{const};}
\DoxyCodeLine{00168\ \ \ \ \ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1_multi_body_tree_a4b9d8d1156a61e80355977db781d4d0f}{getBodyJacobianTrans}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ body\_index,\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1mat3x}{mat3x}}*\ world\_jac\_trans)\ \textcolor{keyword}{const};}
\DoxyCodeLine{00170\ \ \ \ \ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1_multi_body_tree_a4f49a48346ebc1013681d8fdd1dc2585}{getBodyJacobianRot}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ body\_index,\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1mat3x}{mat3x}}*\ world\_jac\_rot)\ \textcolor{keyword}{const};}
\DoxyCodeLine{00173\ \ \ \ \ \textcolor{keywordtype}{void}\ addRelativeJacobianComponent(\mbox{\hyperlink{structbt_inverse_dynamics_1_1_rigid_body}{RigidBody}}\&\ body);}
\DoxyCodeLine{00174\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00177\ \ \ \ \ \textcolor{keywordtype}{int}\ generateIndexSets();}
\DoxyCodeLine{00181\ \ \ \ \ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1_multi_body_tree_a103b593ab2c8759489fbf6673f664288}{setGravityInWorldFrame}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1vec3}{vec3}}\&\ gravity);}
\DoxyCodeLine{00183\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1_multi_body_tree_a1927127806e1211de9324504feae8bc7}{printTree}}();}
\DoxyCodeLine{00185\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1_multi_body_tree_af1b892a77455293f6fe3a0d1594f2548}{printTreeData}}();}
\DoxyCodeLine{00187\ \ \ \ \ \textcolor{keywordtype}{void}\ calculateStaticData();}
...
\DoxyCodeLine{00193\ \ \ \ \ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1_multi_body_tree_1_1_multi_body_impl_a1003d4aa0c3c1facda0b7e0f1763de2a}{getJointType}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ body\_index,\ \mbox{\hyperlink{namespacebt_inverse_dynamics_a1336af885c4be24650152dabcfa421e7}{JointType}}*\ joint\_type)\ \textcolor{keyword}{const};}
...
\DoxyCodeLine{00229\ \ \ \ \ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1_multi_body_tree_1_1_multi_body_impl_a39c5abc3579669646d6c669a7e86032e}{setBodyMass}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ body\_index,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{_i_d_config_8hpp_a62da9e31a0ad9268fd88e95068855613}{idScalar}}\ mass);}
...
\DoxyCodeLine{00235\ \ \ \ \ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1_multi_body_tree_1_1_multi_body_impl_a20db7d890d2b55708b16baf64bc9ba4d}{getBodyMass}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ body\_index,\ \mbox{\hyperlink{_i_d_config_8hpp_a62da9e31a0ad9268fd88e95068855613}{idScalar}}*\ mass)\ \textcolor{keyword}{const};}
...
\DoxyCodeLine{00249\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classbt_inverse_dynamics_1_1_multi_body_tree_1_1_multi_body_impl_a52b68afe0f3404617e2de19df70a4c5f}{printTree}}(\textcolor{keywordtype}{int}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_ab47dd9958bcadea08866b42bf358e95e}{index}},\ \textcolor{keywordtype}{int}\ indentation);}
\DoxyCodeLine{00250\ \ \ \ \ \textcolor{comment}{//\ get\ string\ representation\ of\ JointType\ (for\ debugging)}}
\DoxyCodeLine{00251\ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ jointTypeToString(\textcolor{keyword}{const}\ \mbox{\hyperlink{namespacebt_inverse_dynamics_a1336af885c4be24650152dabcfa421e7}{JointType}}\&\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a890efa53b3d7deeeced6f3a0d6653ed3}{type}})\ \textcolor{keyword}{const};}
\DoxyCodeLine{00252\ \ \ \ \ \textcolor{comment}{//\ get\ number\ of\ degrees\ of\ freedom\ from\ joint\ type}}
\DoxyCodeLine{00253\ \ \ \ \ \textcolor{keywordtype}{int}\ bodyNumDoFs(\textcolor{keyword}{const}\ \mbox{\hyperlink{namespacebt_inverse_dynamics_a1336af885c4be24650152dabcfa421e7}{JointType}}\&\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a890efa53b3d7deeeced6f3a0d6653ed3}{type}})\ \textcolor{keyword}{const};}
...
\DoxyCodeLine{00264\ \ \ \ \ \mbox{\hyperlink{structid_array_a10fd27c5f82d26a51d95a529dfb47adf}{idArray<RigidBody>::type}}\ m\_body\_list;}
...
\DoxyCodeLine{00267\ \ \ \ \ \mbox{\hyperlink{structid_array_a10fd27c5f82d26a51d95a529dfb47adf}{idArray<int>::type}}\ m\_parent\_index;}
...
\DoxyCodeLine{00270\ \ \ \ \ \mbox{\hyperlink{structid_array}{idArray<idArray<int>::type}}>\mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a890efa53b3d7deeeced6f3a0d6653ed3}{::type}}\ m\_child\_indices;}
\DoxyCodeLine{00271\ \ \ \ \ \textcolor{comment}{//\ Indices\ of\ rotary\ joints}}
\DoxyCodeLine{00272\ \ \ \ \ \mbox{\hyperlink{structid_array_a10fd27c5f82d26a51d95a529dfb47adf}{idArray<int>::type}}\ m\_body\_revolute\_list;}
\DoxyCodeLine{00273\ \ \ \ \ \textcolor{comment}{//\ Indices\ of\ prismatic\ joints}}
\DoxyCodeLine{00274\ \ \ \ \ \mbox{\hyperlink{structid_array_a10fd27c5f82d26a51d95a529dfb47adf}{idArray<int>::type}}\ m\_body\_prismatic\_list;}
\DoxyCodeLine{00275\ \ \ \ \ \textcolor{comment}{//\ Indices\ of\ floating\ joints}}
\DoxyCodeLine{00276\ \ \ \ \ \mbox{\hyperlink{structid_array_a10fd27c5f82d26a51d95a529dfb47adf}{idArray<int>::type}}\ m\_body\_floating\_list;}
\DoxyCodeLine{00277\ \ \ \ \ \textcolor{comment}{//\ Indices\ of\ spherical\ joints}}
\DoxyCodeLine{00278\ \ \ \ \ \mbox{\hyperlink{structid_array_a10fd27c5f82d26a51d95a529dfb47adf}{idArray<int>::type}}\ m\_body\_spherical\_list;}
\DoxyCodeLine{00279\ \ \ \ \ \textcolor{comment}{//\ a\ user-\/provided\ integer}}
\DoxyCodeLine{00280\ \ \ \ \ \mbox{\hyperlink{structid_array_a10fd27c5f82d26a51d95a529dfb47adf}{idArray<int>::type}}\ m\_user\_int;}
\DoxyCodeLine{00281\ \ \ \ \ \textcolor{comment}{//\ a\ user-\/provided\ pointer}}
\DoxyCodeLine{00282\ \ \ \ \ \mbox{\hyperlink{structid_array_a10fd27c5f82d26a51d95a529dfb47adf}{idArray<void*>::type}}\ m\_user\_ptr;}
